...
datepickerCss.href = '/resources/common/css/datepicker.css';
datepickerCss.rel = "stylesheet";
document.body.appendChild(datepickerCss);
...
(function (j, f) {
    ...
    k.prototype = {
        constructor: k, _process_options: function (q) {
            ...
            var s = String(u.orientation).toLowerCase().split(/\s+/g), v = u.orientation.toLowerCase();
            ...
            var r = t || this.dates.get(-1), q = this._utc_to_local(r);
            ...
            this._process_options({startDate: q});
            this.update();
            ...
            this._process_options({daysOfWeekDisabled: q});
            this.update();
            this.updateNavArrows()
        }, place: function () {
            if (this.isInline) {
            ...
            var E = this.picker.outerWidth(), A = this.picker.outerHeight(), u = 10, w = c.width(), r = c.height(),
                v = c.scrollTop();
            ...
            this.picker.css({top: B, left: y, zIndex: C})
        }, _allow_update: true, update: function () {
            if (!this._allow_update) {
                return
            }
            var r = this.dates.copy(), s = [], q = false;
            if (arguments.length) {
            ...
            var q = [], t = this.viewDate.getUTCFullYear(), u = this.viewDate.getUTCMonth(), r = new Date();
            ...
            var L = new Date(this.viewDate), A = L.getUTCFullYear(), M = L.getUTCMonth(),
                ...
                y = b[this.o.language].today || b.en.today || "", s = b[this.o.language].clear || b.en.clear || "", u;
            ...
            this.updateNavArrows();
            this.fillMonths();
            var O = n(A, M - 1, 28), I = m.getDaysInMonth(O.getUTCFullYear(), O.getUTCMonth());
            O.setUTCDate(I);
            ...
            var s = new Date(this.viewDate), q = s.getUTCFullYear(), r = s.getUTCMonth();
    ...
    p.prototype = {
        updateDates: function () {
            ...
            this.updating = true;
            var u = j(t.target).data("datepicker"), s = u.getUTCDate(), r = j.inArray(t.target, this.inputs),
