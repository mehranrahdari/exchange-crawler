        ...
        meshop = {// Global Object
            ...
            uploadImageSetup: function (imagePanel, baseLocation, params) {
                ...
                imagePanel.find(".addDrag").off('change').on('change', function (e) {
                    ...
                    // uploading
                    meshop.log("Caricamento", "Chiusondere....");
                    ...
                    addDrag.each(function (i, input) {
                        $.each(input.files, function (index, file) {
                            ...
                            if (!(/\.(jpg)$/i).test(file.name)) {
                                meshop.log("error", "Solo le jpg caricate.");
                                addDrag.val("");
                                return;
                            }
...
// = $('[name='+elm.attr('select2-relation')+']').val();
            ...
            alert: function (ar1, ar2, ar3, ar4, ar5) {
                ...
                msg = ar2;
                title = ar3;
                btn = '<button type="button" class="btn btn-default" data-dismiss="modal">' + (ar4 || 'Chiuso') + '</button>';
                color = "";
                switch (ar1) {
                    case "warning":
                    case "warn":
                    ...
                    default:
                        ...
                        title = ar2;
                        color = "text-primary";
                        btn = '<button type="button" class="btn btn-default" data-dismiss="modal">' + (ar3 || 'Chiuso') + '</button>';
            ...
            copyToClipboard: function (text) {
                ...
                $temp.remove();
                meshop.log('success', 'Copiati correttamente');
            },
 ...
 */
    ...
    (function ($) {
        ...
        $.fn.select2.locales['it'] = {
            formatNoMatches: function () {
                return "Non c'era risultato";
            },
            formatInputTooShort: function (input, min) {
                var n = min - input.length;
                return "Inserire almeno " + n + " carattere.";
            },
            formatInputTooLong: function (input, max) {
                var n = input.length - max;
                return n + " si dovrebbe tagliare caratteri";
            },
            formatSelectionTooBig: function (limit) {
                return "È possibile scegliere solo " + limit;
            },
...
if (isIE()) {
    alert("Il tuo browser non è supportato,aggiornare o Scarica Firefoxs.");
